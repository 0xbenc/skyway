...
const SwitchPromptDialog = () => {
  const switch_prompt_dialog_open = useStore(
    (state) => state.switch_prompt_dialog_open,
  );
  ...
  return (
    <>
      <Dialog
        ...
        open={switch_prompt_dialog_open}
      >
        ...
        <DialogActions>
          <Button variant="text" color="secondary" onClick={switchPromptClose}>
            Cancel
          </Button>
        </DialogActions>
      </Dialog>
